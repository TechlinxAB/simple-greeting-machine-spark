...
const Toaster = ({ ...props }: ToasterProps) => {
  ...
  return (
    <Sonner
      ...
      toastOptions={{
        classNames: {
          toast: "group flex w-full items-center bg-white text-gray-800 rounded-lg shadow-lg py-3 px-5 max-w-[400px] border border-gray-300",
        ...
        style: {
          ...
          borderColor: '#d1d5db', // gray-300 border color
        }
      }}
      {...props}
    />
