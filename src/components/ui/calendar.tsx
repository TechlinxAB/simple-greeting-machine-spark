    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-primary/5 text-primary p-0 opacity-80 hover:opacity-100 hover:bg-primary/10 hidden" // Hide default nav buttons
        ),
        ...
        day_today: "bg-primary/20 text-primary border-none rounded-full font-semibold opacity-100", // Full opacity for today when not selected
        day_outside:
