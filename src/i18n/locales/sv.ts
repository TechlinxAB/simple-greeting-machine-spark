export const sv = {
  ...
  dashboard: {
    ...
    recentActivity: "Senaste tjänster",
  ...
  timeTracking: {
    ...
    productRequired: "Produkt eller tjänst krävs",
    ...
    timeEntryDeleted: "Tidsregistrering borttagen",
    timeEntryUpdated: "Tidsregistrering uppdaterad",
    addTimeEntry: "Lägg till tidsregistrering",
    activitiesFor: "Tjänster för",
    hours: "Timmar",
    minutes: "Minuter",
    whatProduct: "Vilken produkt?",
    whatActivity: "Vilken tjänst?",
    fromTime: "Från tid",
    toTime: "Till tid",
    ...
    timeEntryAdded: "Tidsregistrering tillagd",
  ...
  userStats: {
    ...
    subtitle: "Spåra och analysera användarföretagsprocess",
    overview: "Översikt",
    timeTracking: "Tidsregistrering",
    revenue: "Omsättning",
    totalHours: "Totala timmar",
    ...
    activityBreakdown: "Tjänstfördelning",
