export const sv = {
  ...
  dashboard: {
    title: "Dashboard",
    welcome: "Välkommen till din dashboard",
    ...
    companyNewsAndAnnouncements: "Företagsnyheter & tillkännagivanden",
    latestUpdates: "Senaste uppdateringar",
    addNewsPost: "Lägg till nyhetsinlägg",
    noNewsAvailable: "Inga nyheter tillgängliga",
    clickAddNewsPost: "Klicka på 'Lägg till nyhetsinlägg' för att skapa ett nyhetsinlägg.",
  ...
  timeTracking: {
    ...
    units: "enheter",
    unit: "enhet",
    actualDuration: "Verklig varaktighet",
    ...
    deleteConfirmation: "Är du säker på att du vill radera denna tidsrapport? Detta kan inte ångras.",
    description: "Beskrivning",
    activityProduct: "Tjänst/Produkt",
    saveTimeEntry: "Spara tidsrapport",
  ...
  products: {
    ...
    productCreated: "Produkt skapad framgångsrikt",
    ...
    deleteWarning: "Detta kan inte ångras.",
    deleteError: "Kan inte radera produkt med {{count}} associerade tidsrapporter",
    deleteInvoiceError: "Kan inte radera produkt med {{count}} associerade fakturaposter",
    deleteFailed: "Misslyckades radera produkt",
    ...
    addNewProductToAccount: "Lägg till ny produkt till konto",
